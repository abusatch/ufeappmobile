...
$ew = mysqli_query($koneksi,"select * from tb_menu where jenis = 'DEMARCHES' and id_menu = '69' ");

$ew2 = mysqli_fetch_array($ew);
$desk1 = str_replace('\n',"",$ew2['short_desc']);
...
$ew = mysqli_query($koneksi,"select * from tb_menu where jenis = 'DEMARCHES' and id_menu != '69' order by sort");
}
while($ew2 = mysqli_fetch_array($ew)){
if($no == 1){echo ",";}else{echo ",";}
